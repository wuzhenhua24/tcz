...
# Import and replace utils with Gemini REST version
...
# Replace utils in both modules
page_index_module.utils = utils_replacement
page_index_md_module.utils = utils_replacement
