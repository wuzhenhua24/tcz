...
# does 'from .utils import *', it imports from our ZhipuAI adapter instead
sys.modules['pageindex.utils'] = utils_replacement

# Now import the functions - they will automatically use the ZhipuAI adapter
